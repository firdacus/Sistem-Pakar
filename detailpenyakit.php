        ...
        <div class="form-group"  method="POST">
          ...
          <div class="col-sm-10">
                <?php
                       ...
                       while($data = mysqli_fetch_array ($sql))
                    {
                       echo "<textarea  rows='8' class='form-control' id='penanganan'  readonly>".$data['solusi']."</textarea><br>";
                    }
                ?>
         </div>  
        </div>
                ...
                <?php
                       ...
                       while($data = mysqli_fetch_array ($sql))
                    {
                      if 
                          ($data['gambar'] == '0') {
                                    echo ' 
                                    <div class="text-danger"><h5>Belum ada gambar yang diupload</h5></div>';
                                  } else{
                                    echo '<img src="./gambar_penyakit/'. $data['gambar'] .'" width="480px" height="480px"></img>';
