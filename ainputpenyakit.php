...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      ...
      <form enctype="multipart/form-data" class="form-horizontal" method="post" data-toggle="validator" role="form" action="ainputpenyakit.php">
          ...
          <div class="form-group has-feedback">
			...
			<div class="form-group ">
                ...
                <option>Sawi Hijau</option>
                <option>Seledri</option>
  		        </select>
          ...
          <div class="form-group">
				...
				<div class="col-sm-10">
                    <textarea rows='8' class="form-control" name="solusi"></textarea>
				</div>
			</div>

            <div class="form-group has-feedback">
        <label class="control-label col-sm-2"  for="nama">Upload Gambar Disini :</label>
        <div class="col-sm-10">
...
if (move_uploaded_file($lokasi_file,"$folder")){
  echo "Nama File : <b>$gambar</b> sukses di upload";
                    ...
                    $query="INSERT INTO penyakit SET idpenyakit='$idpenyakit',namapenyakit='$namapenyakit',jenistanaman='$jenistanaman',solusi='$solusi',gambar='$gambar'";
