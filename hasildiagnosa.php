...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><a href="diagnosa.php"><button type="button" class="btn btn-primary btn-block active">KONSULTASI PENYAKIT</button></a></p>
    ...
    <div class="col-sm-8 text-left"> 
      <h2 class="text-center">DETAIL KONSULTASI</h2>
...
<div class="form-group"  method="POST">
          ...
          <div class="col-sm-10">
                <?php
                       ...
                       while($data = mysqli_fetch_array ($sql))
                    {
                       echo '<img src="./gambar_penyakit/'. $data['gambar'] .'" width="480px" height="480px"></img><br>';
                    }
                ?>
                <br>
         </div>  
