  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
        ...
        <br><form id="form1" name="form1" method="post">
               ...
               <?php 
 			        $tampil="select * from penyakit where jenistanaman= \"".$_POST['jenistanaman']."\"";
...
<form id="form2" name="form2" method="post" action="diagnosa.php">
    <div class="panel panel-primary">
        <div class="panel-heading">Pilihan Gejala</div>
        <div class="panel-body">
 			<?php 
            if(isset($_POST['jenistanaman']))
                  if($_POST['jenistanaman']!="jenistanaman"){
 			$tampil="select * from gejala where jenistanaman= \"".$_POST['jenistanaman']."\"";
