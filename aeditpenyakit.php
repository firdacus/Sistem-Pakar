         ...
         <div class="form-group"  method="POST">
      		...
      		<div class="col-sm-10">
                <?php
                       ...
                       while($data = mysqli_fetch_array ($sql))
                    {
                       echo "<textarea  rows='8' class='form-control' id='kulturteknis' name='solusi' >".$data['solusi']."</textarea><br>";
                    }
                ?>
     		 </div>  
        </div>
     ...
     <button type="submit" name ="submit" class="btn btn-primary">Simpan</button>
         ...
         <?php
                    if(isset($_POST['submit'])){
                      ...
                      $query="update penyakit SET namapenyakit='".$_POST['namapenyakit']."', jenistanaman='".$_POST['jenistanaman']."', solusi='".$_POST['solusi']."' WHERE idpenyakit='$id'";
